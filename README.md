...
The Goal of this Project was to create an simple API REST using GRAILS. We took the example of a LIBRARY and BOOKS and try to generate all the possible needs on a simple data model, composed of two entities linked by a composition
